...
export const HARD_BOUNDARIES =
  "HARD BOUNDARIES: regtest only (network " +
  REGTEST_NETWORK +
 ...
 */
export function rejectMainnetIdentifiers(value: string, field: string): void {
...
export function assertRegtestAddress(address: string): void {
...
export function assertHttpUrl(value: string, field: string): URL {
...
export function assertWsUrl(value: string, field: string): URL {
  rejectMainnetIdentifiers(value, field)
  let url: URL
  try {
    url = new URL(value)
...
export function assertHexPubkey(value: string, field: string): void {
